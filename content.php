		    ...
		    <div class="blog-item col s12 m12 l10 offset-l1">
		      <a class="article-link" href="<?php echo get_permalink(); ?>">
		        <div class="col s12 m6">
		          ...
		          <span itemprop="datePublished" class="date grey-text"><?php echo human_time_diff( get_the_time('U'), current_time('timestamp') ) . ' ago'; ?></span><br>
		        ...
		        <div class="col s12 m6">
		        	<div class="align-with-title" itemprop="text">
		          <?php the_excerpt(); ?>
							<?php
							 wp_link_pages( array(
